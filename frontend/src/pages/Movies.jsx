              ...
              <div className="flex items-center gap-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Search..."
                    className="w-[320px] pl-14 pr-5 py-4 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/10 outline-none focus:border-red-500 transition-all duration-300 focus:shadow-[0_0_25px_rgba(255,0,100,0.8)]"
                  />
                ...
                <button
                  ...
                  className="px-8 py-4 rounded-2xl bg-red-600 font-bold relative overflow-hidden transition-all duration-300 hover:scale-105 hover:bg-red-500 hover:shadow-[0_0_35px_rgba(255,0,0,0.9)] active:scale-95"
                >
                  Search
                </button>
