...
function Chatbot() {
  ...
  const handleSend = () => {
    ...
    if (
      ...
      aiText =
        "👋 Hello! I am MovieMind AI.\n\nAsk me about movies, actors, trailers, genres, IMDb ratings, recommendations and more.";
    }
