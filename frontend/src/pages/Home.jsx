    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10">
            ...
            {!user ? (
              ...
              <div className="relative" ref={menuRef}>
                <div
                  ...
                  className="flex items-center gap-3 px-4 md:px-5 py-2 rounded-2xl bg-gradient-to-r from-red-500 to-pink-500 cursor-pointer hover:scale-105 transition-all"
                >
                  <img
                    src={user.photoURL}
                    alt="profile"
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24 text-center">
          ...
          {/* BUTTON CONTAINER — NEW CONTROL FORK ADDED */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
            <button
              onClick={() => navigate("/movies")}
              className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 rounded-3xl bg-gradient-to-r from-red-500 to-pink-500 hover:scale-105 transition-all shadow-[0_0_40px_rgba(255,0,100,0.4)] text-lg font-bold"
            >
              ▶ Explore Movies Trailers
            </button>

            {/* ── NEW BUTTON SPECIFICATION LINKED NATIVELY TO MOVIES VIEW ── */}
            <button
              onClick={() => navigate("/movies", { state: { filter: "all" } })}
              className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 rounded-3xl border border-white/10 bg-white/5 hover:bg-white/10 hover:scale-105 transition-all text-lg font-bold backdrop-blur-xl text-white"
            >
              🔍 Find Your Movie
            </button>
            ...
            <button
              ...
              className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 rounded-3xl border border-white/10 bg-white/5 hover:bg-white/10 hover:scale-105 transition-all text-lg font-bold backdrop-blur-xl"
            >
              ✨ AI Recommendation
            </button>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-6 pb-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="rounded-[35px] border border-white/10 bg-white/5 backdrop-blur-xl p-8 hover:scale-[1.02] transition">
              ...
              <p className="text-white/60 leading-relaxed">
                Modern cinematic UI inspired by premium streaming platforms with
